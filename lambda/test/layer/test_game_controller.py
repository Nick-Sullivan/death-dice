...
# from model.game_items import ConnectionItem, Game, Player, GameState, RollItem
...
#   def state(self):
#     return GameState(
#       game=Game(game_id='ABCD', id='ABCD', mr_eleven='hi'),
#       players=[Player(game_id='ABCD', id='P1')],
...
#     obj.get_state = MagicMock(return_value=GameState(game=Game(), players=[], rolls=[]))
#     obj.save_state = MagicMock()
...
#       game=Game(),
#       players=[Player(finished=False), Player(finished=False)],
#       rolls=[]
#     ))
#     obj.save_state = MagicMock()
